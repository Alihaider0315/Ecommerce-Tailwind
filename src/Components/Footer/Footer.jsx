...
const Footer = () => {
  return (
    ...
    <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col" bis_skin_checked="1">
      ...
      <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center" bis_skin_checked="1">
    ...
    <div className="bg-gray-100" bis_skin_checked="1">
      <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row" bis_skin_checked="1">
        <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 Ecommerce —
